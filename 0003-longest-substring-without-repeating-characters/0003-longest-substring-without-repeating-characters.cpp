...
// p w w k e w
// start = 0, end = 0 charCount = { p: 1 }
// start = 0, end = 1 charCount = { p: 1, w: 1 }
// start = 0, end = 2 charCount = { p: 1, w: 2 } maxLen = 2
//     start = 1 charCount = { p: 0, w: 2 }
//     start = 2 charCount = { p: 0, w: 1 }
// start = 2, end = 3, charCount = { p: 0, w: 1, k: 1 }
// start = 2, end = 4, charCount = { p: 0, w: 1, k: 1, e: 1 }
// start = 2, end = 5, charCount = { p: 0, w: 2, k: 1, e: 1 } maxLen = 3
